...
window.Modernizr = function(e, t, n) {
        ...
        function l(e, t, n) {
            ...
            return o(t, "string") || o(t, "undefined") ? a(i, t) : (i = (e + " " + b.join(r + " ") + r).split(" "), c(i, t, n))
        }
        var s, u, f = {},
            d = t.documentElement,
            p = "modernizr",
            ...
            w = function(e, n, r, o) {
                ...
                if (parseInt(r, 10))
                    for (; r--;) c = t.createElement("div"), c.id = o ? o[r] : p + (r + 1), s.appendChild(c);
                return i = ["&#173;", '<style id="s', p, '">', e, "</style>"].join(""), s.id = p, (u ? s : f).innerHTML += i, f.appendChild(s), u || (f.style.background = "", f.style.overflow = "hidden", l = d.style.overflow, d.style.overflow = "hidden", d.appendChild(f)), a = n(s, e), u ? s.parentNode.removeChild(s) : (f.parentNode.removeChild(f), d.style.overflow = l), !!a
            },
            x = {}.hasOwnProperty;
        u = o(x, "undefined") || o(x.call, "undefined") ? function(e, t) {
            ...
            var n;
            return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : w(["@media (", v.join("touch-enabled),("), p, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
                n = 9 === e.offsetTop
            }), n
        ...
        return f.addTest = function(e, t) {
            ...
            function(e, t) {
                ...
                function c(e) {
                    e || (e = t);
                    var r = o(e);
                    return y.shivCSS && !s && !r.hasCSS && (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || a(e, r), e
                }
                var l;
                e && (l = e.html5);
                var s, u, f = l || {},
                ...
                var y = {
                    ...
                    createDocumentFragment: function(e, n) {
                        ...
                        for (var i = (n = n || o(e)).frag.cloneNode(), a = 0, c = r(), l = c.length; a < l; a++) i.createElement(c[a]);
                        return i
                    }
                };
                l = y, c(t)
            }(this, t), f._version = "2.7.1", f._prefixes = v, f._domPrefixes = b, f._cssomPrefixes = g, f.testProp = function(e) {
                return a([e])
            }, f.testAllProps = l, f.testStyles = w, f.prefixed = function(e, t, n) {
    ...
    function(e, t, n) {
        ...
        function l(e, n, r, o, i, l, s) {
            ...
            1 === N[n] && (v = 1, N[n] = []), "object" == e ? f.data = n : (f.src = n, f.type = e), f.width = f.height = "0", f.onerror = f.onload = f.onreadystatechange = function() {
                u.call(this, v)
            }, y.splice(o, 0, b), "img" != e && (v || 2 === N[n] ? (j.insertBefore(f, E ? null : m), h(u, s)) : N[n].push(f))
        }
        ...
        (d = function(e) {
            function t(e) {
                ...
                for (n = 0; n < a; n++) r = e[n].split("="), (t = T[r.shift()]) && (i = t(i, r));
